function [ Z, funVal, iteration ] = QOSC( X, lambda_1, lambda_2, gamma_1,p, maxIterations, diagconstraint,pos)
%% Problem
%
...
for iteration=1:maxIterations
    ...
    %% Step 1
    A = X'*X;
    B = 2*lambda_1*ones(size(Z))+gamma_1*(R*R');
